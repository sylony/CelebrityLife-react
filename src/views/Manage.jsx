        ...
        <>
                                    ...
                                    <tr key={index}>
                                        ...
                                        <td className='w-44'>
                                            <div className='flex gap-x-2 justify-center'>
                                                ...
                                                <Button variant="danger" onClick={_ => { setSelectUser({ id: item.id, username: item.username }); handleShow() }} >Delete</Button>
                                            </div>
                                        </td>
                                    </tr>
                                ))
            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                    ...
                    <p className='font-bold text-xl'>This operation will not be reversible!</p>
                </Modal.Body>
                <Modal.Footer>
